...
import ru.neustupov.restvoting.util.exception.ErrorInfo;
import ru.neustupov.restvoting.util.exception.ErrorType;
import ru.neustupov.restvoting.util.exception.IllegalRequestDataException;
import ru.neustupov.restvoting.util.exception.NotFoundException;

import javax.servlet.http.HttpServletRequest;

import static ru.neustupov.restvoting.util.exception.ErrorType.*;
